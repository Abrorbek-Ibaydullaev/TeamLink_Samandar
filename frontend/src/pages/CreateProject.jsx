...
export default function CreateProject({ darkMode = true }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Example: await axios.post('/api/projects', { ...formData, members, tags })
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <h1 className={`text-3xl font-bold ${textPrimary} mb-2`}>Create New Project</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className={`${cardBg} backdrop-blur-xl border ${borderColor} rounded-2xl p-6`}>
              <h2 className={`text-xl font-semibold ${textPrimary} mb-6`}>Project Details</h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-xl ${inputBg} border ${borderColor} ${textPrimary} outline-none focus:border-blue-500 transition cursor-pointer`}
                  >
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {colorOptions.map((color) => (
                    ...
                    >
                      <div className={`h-12 rounded-lg bg-gradient-to-r ${color.value}`}></div>
            ...
            <div className={`${cardBg} backdrop-blur-xl border ${borderColor} rounded-2xl p-6`}>
              ...
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  className={`flex-1 px-4 py-3 rounded-xl ${inputBg} border ${borderColor} ${textPrimary} outline-none focus:border-blue-500 transition`}
                />
                <button
                  type="button"
                  onClick={addTag}
          ...
          <div className="space-y-6">
            ...
            {/* Preview */}
            <div className={`${cardBg} backdrop-blur-xl border ${borderColor} rounded-2xl p-6`}>
              <h2 className={`text-xl font-semibold ${textPrimary} mb-4`}>Preview</h2>
            ...
            <div className="space-y-3">
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white py-3 rounded-xl font-medium hover:opacity-90 transition disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
              ...
              <button
                type="button"
                onClick={() => navigate(-1)}
                className={`w-full py-3 rounded-xl ${inputBg} ${textSecondary} hover:${textPrimary} transition font-medium`}
              >
                Cancel
              </button>
            </div>
