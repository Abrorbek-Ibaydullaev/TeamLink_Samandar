...
import { Mail, Lock, User, Eye, EyeOff, UserPlus, Github } from 'lucide-react'
...
export default function Register({ darkMode = true }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Example: await axios.post('http://127.0.0.1:8000/api/register/', formData)
    ...
    <div className={`${bgClass} min-h-screen flex items-center justify-center p-4`}>
      ...
      <div className={`${cardBg} backdrop-blur-xl border ${borderColor} rounded-2xl p-8 md:p-12 w-full max-w-md relative z-10 shadow-2xl`}>
        ...
        <div className="text-center mb-8">
          ...
          <p className={`${textSecondary}`}>Join TeamLink and start collaborating</p>
        </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className={`px-4 ${cardBg} ${textSecondary}`}>Or sign up with</span>
          </div>
        </div>
